...
bool AP_OpticalFlow::init(bool initCommAPI)
{
...
void AP_OpticalFlow::update_position(float roll, float pitch, float cos_yaw_x, float sin_yaw_y, float altitude)
{
